...
var cont = 0;
var c1, c2, c3, c4, nota_final = 0;
var prom_aprob = 0, prom_noAprob = 0, prom = 0;
var cont_aprobaron = 0, cont_noAprobaron = 0, nota = 0, nota_noAprob = 0, nota_aprob = 0, notaFinal_Aprobaron = 0, notaFinal_noAprobaron = 0;
var cont_c1Aprobados = 0, cont_c1NoAprobados = 0;
var cont_c2Aprobados = 0, cont_c2NoAprobados = 0;
var cont_c3Aprobados = 0, cont_c3NoAprobados = 0;
var cont_c4Aprobados = 0, cont_c4NoAprobados = 0;
var promDeficiente = 0, promBajo = 0, promBasico = 0, promAlto = 0, promSuperior = 0;
var contDeficiente = 0, contBajo = 0, contBasico = 0, contAlto = 0, contSuperior = 0;
var promFinalDeficiente = 0, promFinalBajo = 0, promFinalBasico = 0, promFinalAlto = 0, promFinalSuperior = 0;
var promNotaDeficiente = 0, promNotaBajo = 0, promNotaBasico = 0, promNotaAlto = 0, promNotaSuperior = 0;
function Notas() {
    var t = 1, tr, p, t2, tr2, ex2, p2, t3, tr3, p3, t4, tr4, ex4, p4;
    while (t > 0) {
        /**corte 1 */
    ...
    console.log("Estudiantes que aprobaron el 1er periodo: " + cont_c1Aprobados +
        "\nEstudiantes que reprobaron el 1er periodo: " + cont_c1NoAprobados);

    console.log("Estudiantes que aprobaron el 2do periodo: " + cont_c2Aprobados +
        "\nEstudiantes que reprobaron el 2do periodo: " + cont_c2NoAprobados);

    console.log("Estudiantes que aprobaron el 3er periodo: " + cont_c3Aprobados +
        "\nEstudiantes que reprobaron el 3er periodo: " + cont_c3NoAprobados);

    console.log("Estudiantes que aprobaron el 4to periodo: " + cont_c4Aprobados +
        "\nEstudiantes que reprobaron el 4to periodo: " + cont_c4NoAprobados);
